...
class HBNBCommand(cmd.Cmd):
    ...
    def do_create(self, args):
        ...
        if not args:
            ...
            return
        #To check if args contain parameters
        p_dict = {}
        if ('=' in args and '' in args):
            #to separate args into  classes and parameters
            args = args.partition(' ')
            class_name = args[0]
            params = args[2].split(' ')

            #The params will be converted into a dictionary
            for item in params:
